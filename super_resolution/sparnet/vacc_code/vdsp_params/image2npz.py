...
if __name__ == "__main__":
    ...
    parse.add_argument("--hr_path", type=str, default="/home/simplew/code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/HR", help="path to input source image folder")
    parse.add_argument("--lr_path", type=str, default="/home/simplew/code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/LR", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/LR_npz", help="path to output npz image folder")
