...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/HR", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/sparnet_light_attn3d", help="vamp output folder")
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        for i, line in enumerate(tqdm(file_lines)):
            ...
            # eval
            image_gt = Image.open(os.path.join(args.gt_dir, file_name))
            image_gt = image_gt.resize(args.input_shape, Image.NEAREST).convert('RGB')
...
"""
sparnet_light_attn3d-fp16-none-3_128_128-vacc
mean psnr: 23.74607170801967, mean ssim: 0.771290720184679
sparnet_light_attn3d-int8-kl_divergence-3_128_128-vacc
mean psnr: 23.12344014418596, mean ssim: 0.7046051138353465
"""