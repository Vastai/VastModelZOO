...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_LR_bicubic/npz_datalist_X2.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/edsr", help="vamp output folder")
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        for i, line in enumerate(tqdm(file_lines)):
            ...
            image_gt = cv2.imread(os.path.join(args.gt_dir, os.path.basename(file_name).replace("x2", "")))
...
"""
edsr_baseline_x2-int8-kl_divergence-3_256_256-vacc
mean psnr: 23.748339270149636, mean ssim: 0.7504512032174339


EDSR_x2-int8-kl_divergence-3_256_256-vacc
mean psnr: 24.195981311241308, mean ssim: 0.7170519965939556
EDSR_x2-int8-kl_divergence-3_256_256-vacc 缩放后生成npz img_data = cv2.resize(img_data, [256, 256], interpolation=cv2.INTER_AREA)
mean psnr: 29.131393374556026, mean ssim: 0.8879885927320562
