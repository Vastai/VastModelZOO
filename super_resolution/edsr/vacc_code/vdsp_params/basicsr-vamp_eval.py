...
if __name__ == "__main__":
    ...
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/rcan", help="vamp output folder")
    parse.add_argument("--input_shape", nargs='+', type=int, default=[678, 1024], help="vamp input shape h,w")
...
DIV2K
EDSR_Mx2-int8-percentile-3_678_1024-vacc
mean psnr: 33.35045181248754, mean ssim: 0.9080128062636258
