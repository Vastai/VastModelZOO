...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/dataset/sr/CelebAMask-HQ/test_img", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/fsrnet", help="vamp output folder")
