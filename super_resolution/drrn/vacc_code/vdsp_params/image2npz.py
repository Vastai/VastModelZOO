...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/code/model_check/SR/sr/pytorch-vdsr/Set5_BMP/scale_4", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/code/model_check/SR/sr/pytorch-vdsr/Set5_BMP/scale_4_npz", help="path to output npz image folder")
