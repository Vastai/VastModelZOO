...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_HR", help="path to input source image folder")
    parse.add_argument("--hr_path", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/realsr/DIV2K_valid_HR_512", help="path to input source image folder")
    parse.add_argument("--lr_path", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/realsr/DIV2K_valid_LR_128", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/realsr/DIV2K_valid_LR_128_npz", help="path to output npz image folder")
