...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/model_check/SR/BasicSR/datasets/DIV2K/realsr/DIV2K_valid_HR_512", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="output/DF2K", help="vamp output folder")
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        print("mean psnr: {}, mean ssim: {}".format(np.mean(psnr_list), np.mean(vacc_ssim)))

"""
DF2K-fp16-none-3_128_128-vacc
mean psnr: 23.65423485011217, mean ssim: 0.644076910217011
"""