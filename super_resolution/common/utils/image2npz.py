...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/dataset/sr/deblur/data_720_1280/GOPR0384_11_00/blur", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/dataset/sr/deblur/data_720_1280/GOPR0384_11_00/blur_npz", help="path to output npz image folder")
