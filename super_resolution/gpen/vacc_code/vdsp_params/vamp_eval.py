...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/eval/GPEN/hq", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="datalist_npz.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/save/gpen", help="vamp output folder")
    parse.add_argument("--input_shape", nargs='+', type=int, default=[512, 512], help="vamp input shape")
    parse.add_argument("--draw_dir", type=str, default="npz_result", help="vamp npz draw image reult folder")
...
""" 
fasesr-int8-mse-3_512_512-vacc
mean psnr: 25.934029366808357, mean ssim: 0.8189851016040611
"""
