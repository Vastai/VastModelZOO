...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="/home/simplew/code/model_check/SR/deblur_denoise/Real-ESRGAN/datalist_npz.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/bsrnet_x4", help="vamp output folder")
