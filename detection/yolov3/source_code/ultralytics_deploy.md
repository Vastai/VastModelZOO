...
3. 性能测试
    ```bash
    vamp -m deploy_weights/yolov3-int8-kl_divergence-3_320_320-vacc/yolov3 --vdsp_params ../vacc_code/vdsp_params/ultralytics-yolov3-vdsp_params.json -i 2 p 2 -b 1
    ```
4. npz结果输出
    ```bash
    vamp -m deploy_weights/yolov3-int8-kl_divergence-3_320_320-vacc/yolov3 --vdsp_params ../vacc_code/vdsp_params/ultralytics-yolov3-vdsp_params.json -i 2 p 2 -b 1 --datalist datasets/coco_npz_datalist.txt --path_output npz_output
    ```
