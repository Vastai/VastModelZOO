...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/eval/coco_val2017", help="path to input source image folder")
    parse.add_argument("--input_npz_path", type=str, default="/home/simplew/code/eval/npz_datalist_coco_eval.txt", help="vamp data list text file path")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/centernet", help="path to vamp output npz image folder")
