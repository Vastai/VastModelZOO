...
def set_config():
    ...
    parse.add_argument(
        "--image_dir",
        type=str,
        default="/home/simplew/dataset/seg/cityscapes/leftImg8bit/val",
        help="img dir",
    )
    parse.add_argument(
        "--mask_dir",
        type=str,
        default="/home/simplew/dataset/seg/cityscapes/gtFine/val",
        help="mask_dir",
    )
    parse.add_argument(
        "--model_prefix_path",
...
if __name__ == '__main__':
    ...
    colors = np.loadtxt("segmentation/bisenet/vacc_code/runmodel/cityscapes_colors.txt").astype('uint8')
