...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/home/simplew/code/model_check/UnetPlusPlus/dsb2018_256_val/images", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/model_check/UnetPlusPlus/dsb2018_256_val/masks", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/r2u_net", help="vamp output folder")
...
""" 
r2u_net-fp16-none-3_96_96-vacc
mean DIC: 85.963, mean IoU: 77.416
r2u_net-int8-kl_divergence-3_96_96-vacc
mean DIC: 85.700, mean IoU: 77.077
"""
