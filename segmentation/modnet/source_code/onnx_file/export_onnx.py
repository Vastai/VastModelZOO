...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt-path', type=str, required=False, default="pretrained/modnet_photographic_portrait_matting.ckpt")
    parser.add_argument('--output-path', type=str, required=False, default="pretrained/modnet_photographic_portrait_matting10_480_288.onnx")
