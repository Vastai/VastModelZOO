...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-path', type=str, default="datasets/PPM-100/image/6146816_556eaff97f_o.jpg", help='path of the input image (a file)')
    parser.add_argument('--output-path', type=str, default="./output/6146816_556eaff97f_o.jpg", help='paht for saving the predicted alpha matte (a file)')
    parser.add_argument('--model-path', type=str, default="pretrained/modnet_photographic_portrait_matting10.onnx", help='path of the ONNX model')
