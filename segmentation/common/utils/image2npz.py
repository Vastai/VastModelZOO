...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/dataset/seg/carvana/imgs", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/dataset/seg/carvana/imgs_npz", help="path to output npz image folder")
