...
# 从JPEGImages中找出评估图像，并复制到一个新的文件夹，且转换评估图像至npz
copy_val_dir = "/home/simplew/dataset/seg/VOCdevkit/VOC2012/JPEGImages_val"
val_text = "/home/simplew/dataset/seg/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt"
...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/dataset/seg/VOCdevkit/VOC2012/JPEGImages", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/dataset/seg/VOCdevkit/VOC2012/JPEGImages_val_npz", help="path to output npz image folder")
