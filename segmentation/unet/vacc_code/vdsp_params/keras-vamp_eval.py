...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/home/simplew/code/model_check/keras_unet/data/membrane/train/image", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/model_check/keras_unet/data/membrane/train/label", help="hr gt image folder")
