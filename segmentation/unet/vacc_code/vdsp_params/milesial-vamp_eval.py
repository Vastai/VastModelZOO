...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/home/simplew/dataset/seg/carvana/imgs", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/dataset/seg/carvana/masks", help="hr gt image folder")
