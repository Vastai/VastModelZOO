...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="/home/simplew/dataset/seg/VOCdevkit/VOC2012/npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/home/simplew/code/vamc/vamp/0.2.0/outputs/unet", help="vamp output folder")
