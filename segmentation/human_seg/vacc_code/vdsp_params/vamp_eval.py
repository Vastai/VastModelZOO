...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/home/simplew/code/model_check/Human-Segmentation-PyTorch/dataset/Supervisely_Person_Dataset/src", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/code/model_check/Human-Segmentation-PyTorch/dataset/Supervisely_Person_Dataset/mask", help="hr gt image folder")
