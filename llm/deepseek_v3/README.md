...
- `--port`：vLLM 推理服务端口，需在“ds-xxx-docker-compose.yaml”中查看确认。其中，“ds-xxx-docker-compose.yaml”为 DeepSeek V3系列模型对应的 Docker Compose 配置文件，请根据实际情况替换。
...
eval_type: "service"
work_dir: "./outputs_0704/outputs_eval_ds_v3"
