...
echo "server index: $INDEX, die_count: $COUNT, port: $PORT, MODEL: $MODEL, MAX_MODEL_LEN: $MAX_MODEL_LEN, VACC_VISIBLE_DEVICES: $VACC_VISIBLE_DEVICES, ALLOW_LONG_MAX_MODEL_LEN: $ALLOW_LONG_MAX_MODEL_LEN, ENABLE_REASONING: $ENABLE_REASONING, REASONING_PARSER: $REASONING_PARSER, QWEN_ROPE_STR: $QWEN_ROPE_STR,TOOL_CHOICE_STR: $TOOL_CHOICE_STR,CHAT_STR:$CHAT_STR,DEEPSEEK_MTP_STR:$DEEPSEEK_MTP_STR,TASKSET_STR:$TASKSET_STR"
