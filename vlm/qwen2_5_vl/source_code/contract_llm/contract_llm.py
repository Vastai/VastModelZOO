...
def extract_and_chunk_llm_weights(
    ...
    llm_output_dir="qwen2_5_7b_llm_chunks",
    max_size_gb=3.5,
):
    os.makedirs(llm_output_dir, exist_ok=True)

    vl_model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
        vl_model_path, torch_dtype="auto", device_map="cpu"
    )
...
if __name__ == "__main__":
    ...
    vl_dir = "/path/to/Qwen2.5-VL-7B-Instruct-GPTQ-Int4"
    vl_llm_dir = "/path/to/Qwen2.5-VL-7B-Instruct-GPTQ-Int4-llm"
    ...
    #     vl_llm_dir, device_map="cuda:0", torch_dtype=torch.float16
    # )
