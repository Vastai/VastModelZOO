...
parse.add_argument(
    "--file_path",
    type=str,
    default="./work/VAMC_TEST/data/ILSVRC2012_img_val/", 
    help="img or dir  path",
)
parse.add_argument("--model_prefix_path", type=str, default="models/int8/facenet_casia_webface-int8-kl_divergence-3_160_160-vacc/facenet_casia_webface", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="vdsp_params/pytorch-facenet_casia_webface-vdsp_params.json",
    help="vdsp op info",
)
parse.add_argument(
...
class Classify:
    ...
    def post_processing(self, class_list, input_id, height, width, stream_output_list):
        ...
        self.result_dict[input_id].append(
            {
                "embedding_dims": len(output_data),
                "embedding": output_data.tolist(),
            }
        )
