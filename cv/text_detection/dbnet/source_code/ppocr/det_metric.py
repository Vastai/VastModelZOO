...
class DetMetric(object):
    ...
    def __call__(self, det_polys, gt_polyons_batch, ignore_tags_batch, **kwargs):
        '''
       ...
       '''
        det_polys = [det_polys]
        gt_polyons_batch = [gt_polyons_batch]
        ignore_tags_batch = [ignore_tags_batch]
        for preds, gt_polyons, ignore_tags in zip(det_polys, gt_polyons_batch,
                                                 ignore_tags_batch):
            # prepare gt
            gt_info_list = [{
                'points': gt_polyon,
