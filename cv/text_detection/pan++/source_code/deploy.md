...
1. 修改[pan_pp forward](https://github.com/whai362/pan_pp.pytorch/blob/master/models/pan_pp.py)输出
...
2. export
   ...
   ```bash
    python ../source_code/export.py ./config/pan_pp/pan_pp_r18_ic15_736_det_only.py weights/pan++/panpp_r18_ic15_det.pth.tar
   ```
...
1. runstream
    ...
    python ../build_in/vsx/python/vsx.py \
        ...
        --model_prefix_path deploy_weights/pytorch_pan++_stream_fp16/mod \
        --vdsp_params_info ../build_in/vdsp_params/pan_pp.pytorch-panpp_r18_ic15_det-vdsp_params.json \
    ...
    ```
    # fp16
    {"precision": 0.8368502316006176, "recall": 0.7828598940779972, "hmean": 0.8089552238805972, "AP": 0}

    # int8
    {"precision": 0.8456725755995829, "recall": 0.7809340394800193, "hmean": 0.8120150187734668, "AP": 0}
    ```

### step.5 性能精度测试
1. 性能测试
    - 配置vdsp参数[pan_pp.pytorch-panpp_r18_ic15_det-vdsp_params.json](../build_in/vdsp_params/pan_pp.pytorch-panpp_r18_ic15_det-vdsp_params.json)，执行：
    ```bash
    vamp -m deploy_weights/pytorch_pan++_stream_int8/mod \
        --vdsp_params ../build_in/vdsp_params/pan_pp.pytorch-panpp_r18_ic15_det-vdsp_params.json \
        -i 1 p 1 -b 1
    ```
...
2. 精度测试
    ...
    ```bash
    python npz_decode.py --gt_dir /path/to//ocr/ICDAR2015/ch4_test_images --input_npz_path npz_datalist.txt --out_npz_dir npz_out --save_dir output_npz
    ```
