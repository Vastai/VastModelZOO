...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/path/to/dataset/ocr/icdar2015/Challenge4/ch4_test_images", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/path/to/dataset/ocr/icdar2015/Challenge4/ch4_test_images_npz", help="path to output npz image folder")
