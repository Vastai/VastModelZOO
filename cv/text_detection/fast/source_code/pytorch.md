...
1. runstream
    ...
    python ../build_in/vsx/python/fast_vsx.py \
        ...
        --model_prefix_path deploy_weights/pytorch_fast_run_stream_fp16/mod \
...
1. 性能测试
    ...
    ```
    vamp -m ./deploy_weights/pytorch_fast_run_stream_int8/mod --vdsp_params ../build_in/vdsp_params/pytorch-fast_tiny_ctw_512_finetune_ic17mlt-vdsp_params.json -i 1 p 1 -b 1
    ```
...
2. 精度测试
    ...
    - vamp推理得到npz结果：
    ```bash
    vamp -m ./deploy_weights/pytorch_fast_run_stream_int8/mod --vdsp_params ../build_in/vdsp_params/pytorch-fast_tiny_ctw_512_finetune_ic17mlt-vdsp_params.json -i 1 p 1 -b 1 --datalist npz_datalist.txt --path_output npz_output
    ```
