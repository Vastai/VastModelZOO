...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="./dataset/low_light_enhance/LOL/eval15/low", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="./dataset/low_light_enhance/LOL/eval15/low_npz", help="path to output npz image folder")
