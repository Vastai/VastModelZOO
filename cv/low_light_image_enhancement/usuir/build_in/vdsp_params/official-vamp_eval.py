...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="UIE-dataset/UIEBD/test/label", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/vamc/vamp/2.1.0/npz_output", help="vamp output folder")
    parse.add_argument("--input_shape", nargs='+', type=int, default=[720, 1280], help="vamp input shape h,w")
...
mean psnr: 20.401331481191278, mean ssim: 0.8552892947661273

UIEBD_final_sim-int8-kl_divergence-1_3_720_1280-vacc
mean psnr: 20.3860545935244, mean ssim: 0.8476951472417626
"""
