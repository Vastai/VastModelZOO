...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/dataset/low_light_enhance/LOL/eval15/high", help="hr gt image folder")
    ...
    parse.add_argument("--input_shape", nargs='+', type=int, default=[400, 600], help="vamp input shape h,w")
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        for i, line in enumerate(tqdm(file_lines)):
            ...
            heatmap_l = np.load(npz_file, allow_pickle=True)["output_0"].astype("float32")
            heatmap_r = np.load(npz_file, allow_pickle=True)["output_1"].astype("float32")
...
mean psnr: 18.288140198693778, mean ssim: 0.7453404405623625

PairLIE-int8-kl_divergence-1_3_400_600-vacc
mean psnr: 18.279539940076532, mean ssim: 0.721826496821647
"""
