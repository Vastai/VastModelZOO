...
def argument_parser():
    ...
    parser.add_argument(
        "--gaha_model_prefix",
        default="/path/to/elic-compress-g_a-h_a-fp16-1_3_512_512-vacc/mod",
    ...
    parser.add_argument(
        "--hs_model_prefix",
        default="/path/to/elic-compress-h_s_chunk-fp16-1_192_8_8-vacc/mod",
    ...
    parser.add_argument(
        "--gs_model_prefix",
        default="/path/to/elic-compress-g_s_chunk-fp16-1_192_8_8-vacc/mod",
