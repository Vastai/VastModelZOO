...
parser.add_argument("--model_name", type=str, default="PP-LCNet_x1_0_doc_ori",
                    help="Pretrained model name (e.g. PP-LCNet_x1_0_doc_ori)")
...
if __name__ == '__main__':
    ...
    model = DocImgOrientationClassification(**kwargs)
    ...
    with open(args.output_file, "w") as outfile:
        for img_path in tqdm.tqdm(images, desc="Evaluating"):
            ...
            print(f"{basename}: Paddle={decode_out}")
            outfile.write(f"{basename} Paddle={decode_out}\n")
