...
def parse_args():
    ...
    parser.add_argument('--infile',default='./model/pretrained/',help="folder of pre-trained model")
    parser.add_argument('--output',default='./model/onnx',help="path to save onnx file")
