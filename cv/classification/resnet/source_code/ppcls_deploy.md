...
### step.4 模型推理
 - 参考：[classification.py](../../common/vsx/classification.py)
    ...
    python ../../common/vsx/classification.py \
        ...
        --model_prefix_path deploy_weights/ppcls_resnet_fp16/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/ppcls_resnet50_fp16/mod --vdsp_params ../build_in/vdsp_params/ppcls-resnet50-vdsp_params.json  -i 8 -p 1 -b 2 -s [3,224,224]
    ```
...
2. 精度测试
    ...
    - vamp推理获取npz文件
    ```
    vamp -m deploy_weights/ppcls_resnet50_fp16/mod --vdsp_params ../build_in/vdsp_params/ppcls-resnet50-vdsp_params.json  -i 8 -p 1 -b 22 -s [3,224,224] --datalist imagenet_npz.txt --path_output output
    ```
