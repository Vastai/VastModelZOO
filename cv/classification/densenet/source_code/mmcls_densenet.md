...
1. runstream
    ...
    python ../../common/vsx/python/classification.py \
        ...
        --model_prefix_path deploy_weights/mmcls_densenet_run_stream_int8/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m mmcls_densenet_run_stream_int8/mod --vdsp_params ../build_in/vdsp_params/mmcls-densenet121-vdsp_params.json  -i 8 -p 1 -b 2 -s [3,224,224] 
    ```
...
2. 精度测试
    ...
    - vamp推理获取npz文件结果
    ```bash
    vamp -m deploy_weights/mmcls_densenet_run_stream_int8/densenet --vdsp_params ../build_in/vdsp_params/mmcls-densenet121-vdsp_params.json  -i 8 -p 1 -b 22 -s [3,224,224] --datalist imagenet_npz.txt --path_output output
    ```
