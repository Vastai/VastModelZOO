...
def parse_args():
    ...
    parser.add_argument('--infile',default='./workspace/dla/pretrained_weight/',help="folder of pre-trained model")
    parser.add_argument('--output',default='./workspace/',help="path to save onnx file")
