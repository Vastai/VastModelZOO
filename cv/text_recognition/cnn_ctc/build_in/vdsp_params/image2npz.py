...
parse.add_argument("--target_path", type=str, default="./code/eval/coco_val2017_npz", help="path to output npz image folder")
...
def make_npz_text(args):
    ...
    with open(args.text_path, 'w') as f:
        ...
        for img_file in tqdm(files_list):
            ...
            data = np.expand_dims(np.array(img_data), -1)
