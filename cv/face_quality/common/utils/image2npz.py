...
# -*- encoding: utf-8 -*-
'''
@Author :  lance.wang@vastaitech.com
@Time  :     2023/05/15 20:41:36
'''
...
parse.add_argument("--dataset_path", type=str, default="/path/to/ms1m_example", help="path to input source image folder")
parse.add_argument("--target_path", type=str, default="/path/to/ms1m_example_npz", help="path to output npz image folder")
parse.add_argument("--text_path", type=str, default="/path/to/ms1m_example_npz.txt")
