...
parse.add_argument(
    "--file_path",
    type=str,
    default="./work/VAMC_TEST/data/ILSVRC2012_img_val/", #"test_img/ILSVRC2012_val_00000003.JPEG",
    help="img or dir  path",
)
parse.add_argument("--model_prefix_path", type=str, default="./models/deploy/resnet18-int8-percentile-1_3_224_224-vacc/resnet18", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="./models/params_info/torchvision-resnet18-vdsp_params.json",
    help="vdsp op info",
)
parse.add_argument(
