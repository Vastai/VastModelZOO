...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/path/to/Human-Segmentation-PyTorch/dataset/Supervisely_Person_Dataset/src", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/path/to/Human-Segmentation-PyTorch/dataset/Supervisely_Person_Dataset/src_npz", help="path to output npz image folder")
