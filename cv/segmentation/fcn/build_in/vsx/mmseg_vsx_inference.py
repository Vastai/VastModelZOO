...
def set_config():
    ...
    parser.add_argument("--model_prefix_path",type=str,default="deploy_weights/mmseg_fcn_run_model_fp16/mod",help="model info")
    parser.add_argument("--vdsp_params_info",type=str,default="../vacc_code/vdsp_params/mmseg-fcn_r50_d8_20k-vdsp_params.json",help="vdsp op info",)
...
if __name__ == '__main__':
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        # draw
        tvm_predict = torch.tensor(result).unsqueeze(0)
