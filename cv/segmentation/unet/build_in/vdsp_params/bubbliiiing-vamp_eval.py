...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="./VOCdevkit/VOC2012/JPEGImages_val", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="./VOCdevkit/VOC2012/SegmentationClass", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="./VOCdevkit/VOC2012/npz_datalist.txt", help="npz text file")
    ...
    from source_code.bubbliiiing.score import SegmentationMetric
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        for i, line in enumerate(tqdm(file_lines)):
            ...
            # colors = np.loadtxt("segmentation/unet/source_code/bubbliiiing/voc2012_colors.txt").astype('uint8')
...
"""
unet_resnet50-fp16-none-3_256_256-vacc
validation pixAcc: 91.655, mIoU: 66.979
unet_resnet50-int8-kl_divergence-3_256_256-vacc
validation pixAcc: 91.602, mIoU: 66.824

unet_vgg16-fp16-none-3_256_256-vacc
validation pixAcc: 91.388, mIoU: 63.208
unet_vgg16-int8-kl_divergence-3_256_256-vacc
validation pixAcc: 91.313, mIoU: 62.940
"""
