...
def set_config():
    ...
    parse.add_argument(
        "--file_path",
        type=str,
        default="/path/to/VOCdevkit/VOC2012/JPEGImages_val",
        help="img dir",
    )
    parse.add_argument(
        "--gt_path",
        type=str,
        default="/path/to/VOCdevkit/VOC2012/SegmentationClass",
        help="mask_dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/bubbliiiing_unet_run_stream_int8/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/bubbliiiing-unet_resnet50-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        ########################################################################################################
        # eval
        label_path = os.path.join(args.gt_path, os.path.basename(image_path).replace(".jpg", ".png"))
