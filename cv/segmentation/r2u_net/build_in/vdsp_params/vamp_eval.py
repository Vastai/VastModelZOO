...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/path/to/dsb2018_256_val/images", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/path/to/dsb2018_256_val/masks", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/r2u_net", help="vamp output folder")
