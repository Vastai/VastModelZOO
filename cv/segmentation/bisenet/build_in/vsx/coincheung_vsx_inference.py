...
def set_config():
    ...
    parse.add_argument(
        "--image_dir",
        type=str,
        default="./dataset/seg/cityscapes/leftImg8bit/val",
        help="img dir",
    )
    parse.add_argument(
    "--label_txt", type=str, default="segmentation/bisenet/vacc_code/runmodel/cityscapes_colors.txt", help="label txt")
    parse.add_argument(
        "--mask_dir",
        type=str,
        default="./dataset/seg/cityscapes/gtFine/val",
        help="mask_dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/bisenetv1-int8-kl_divergence-1_3_736_960-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="segmentation/bisenet/vacc_code/vdsp_params/coincheung-bisenetv1-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    # model  = torch.jit.load("bisenetv1-736_960.torchscript.pt", map_location=device)
    ...
    colors = np.loadtxt(args.label_txt).astype('uint8')
...
"""
bisenetv1-736_960.torchscript.pt
validation pixAcc: 94.101, mIoU: 67.466

bisenetv1-int8-kl_divergence-1_3_736_960-vacc
validation pixAcc: 93.604, mIoU: 64.614
"""
