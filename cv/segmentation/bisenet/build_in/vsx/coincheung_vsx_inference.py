...
def set_config():
    ...
    parse.add_argument(
    "--label_txt", type=str, default="segmentation/bisenet/source_code/cityscapes_colors.txt", help="label txt")
    parse.add_argument(
        "--mask_dir",
        type=str,
    ...
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="segmentation/bisenet/build_in/vdsp_params/coincheung-bisenetv1-vdsp_params.json",
        help="vdsp op info",
    )
