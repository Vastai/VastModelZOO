...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/path/to/dataset/seg/cityscapes/leftImg8bit/val", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/path/to/dataset/seg/cityscapes/gtFine/val", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/hrnet_w48", help="vamp output folder")
    parse.add_argument("--input_shape", nargs='+', type=int, default=[512, 512], help="vamp input shape, w,h")
    ...
    with open(args.input_npz_path, 'r') as f:
        ...
        for i, line in enumerate(tqdm(file_lines)):
            ...
            colors = np.loadtxt("segmentation/hrnet/source_code/official/cityscapes_colors.txt").astype('uint8')
            ...
            label = cv2.resize(label, args.input_shape, interpolation=cv2.INTER_NEAREST)
...
""" 
hrnet_w48_cityscapes-int8-kl_divergence-3_512_512-vacc
validation pixAcc: 93.658, mIoU: 63.792
hrnet_w48_cityscapes-fp16-none-3_512_512-vacc
validation pixAcc: 93.781, mIoU: 65.329
