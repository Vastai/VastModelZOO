...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg',
                        ...
                        type=str,
                        default="./code/model_check/temp/HRNet-Semantic-Segmentation/experiments/lip/seg_hrnet_w48_473x473_sgd_lr7e-3_wd5e-4_bs_40_epoch150.yaml")
    parser.add_argument('--pth_file',type=str, default="./code/model_check/temp/HRNet-Semantic-Segmentation/weights/hrnet_w48_lip_cls20_473x473_pytorch-v11.pth")
    parser.add_argument('--image_path',type=str, default="./dataset/seg/cityscapes/leftImg8bit/val/frankfurt/frankfurt_000000_000294_leftImg8bit.png")
