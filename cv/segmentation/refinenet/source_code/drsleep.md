...
### step.4 模型推理
    ...
    python ../build_in/vsx/python/vsx_inference.py \
        ...
        --model_prefix_path deploy_weights/official_refinenet_fp16/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/official_refinenet_fp16/mod \
...
2. 精度测试
    ...
    - vamp推理得到npz结果
    ```bash
    vamp -m deploy_weights/official_refinenet_int8/mod \
        --vdsp_params ../build_in/vdsp_params/drsleep-refinenet_resnet101-vdsp_params.json \
        -i 1 p 1 -b 1 -s [3,500,500] \
