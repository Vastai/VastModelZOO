...
copy_val_dir = "/path/to/dataset/seg/VOCdevkit/VOC2012/JPEGImages_val"
val_text = "/path/to/dataset/seg/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt"
...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/path/to/dataset/seg/VOCdevkit/VOC2012/JPEGImages", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/path/to/dataset/seg/VOCdevkit/VOC2012/JPEGImages_val_npz", help="path to output npz image folder")
