...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/path/to/dataset/seg/cityscapes/leftImg8bit/val", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/path/to/dataset/seg/cityscapes/leftImg8bit/val_npz", help="path to output npz image folder")
