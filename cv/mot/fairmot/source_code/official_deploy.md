...
1. runstream
    ...
    python ../build_in/vsx/python/fairmot_vsx.py \
        ...
        --model_weight_path deploy_weights/official_fairmot_run_stream_int8/ \
        --model_name mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/official_fairmot_run_stream_int8/mod --vdsp_params ../build_in/vdsp_params/official-fairmot_yolov5s-vdsp_params.json -i 1 -b 1 -d 0 -p 1
    ```
