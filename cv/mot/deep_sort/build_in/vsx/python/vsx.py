...
def set_config():
    ...
    parse.add_argument(
        "--image_dir",
        type=str,
        default="/path/to/MOT17-01-FRCNN/img1/",
        help="img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_deepsort_run_stream_int8/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-deepsort-vdsp_params.json",
        help="vdsp op info",
    )
