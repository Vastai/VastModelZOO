...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/path/to/dataset/sod/ECSSD/image", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/path/to/dataset/sod/ECSSD/mask", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="/path/to/dataset/sod/ECSSD/npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs", help="vamp output folder")
...
|-----------|-------|---------------|---------------|---------------|----------------|----------------|-------------|-------------|---------|---------|---------|-------|-------|
| Method1   | 0.052 |         0.908 |         0.892 |         0.895 |          0.981 |          0.924 |           1 |        0.87 |   0.929 |   0.916 |   0.923 | 0.896 | 0.866 |
"""
