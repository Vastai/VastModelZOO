...
- 参考：[official_vsx_inference.py](../build_in/vsx/python/official_vsx_inference.py)
    ...
    python ../build_in/vsx/python/salod_vsx_inference.py \
        ...
        --model_prefix_path deploy_weights/official_basnet_fp16/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/official_basnet_fp16/mod \
...
2. 精度测试
    ...
    - vamp推理得到npz结果
    ```bash
    vamp -m deploy_weights/official_basnet_fp16/basnet \
        --vdsp_params ../build_in/vdsp_params/official-basnet-vdsp_params.json \
        -i 1 p 1 -b 1 \
