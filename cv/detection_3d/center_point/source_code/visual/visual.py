...
parser.add_argument('--task',
                    type=str,
                    default='pointcloud',
                    choices=['pointcloud', 'box3d'])
parser.add_argument('--points_file',
                    type=str,
                    default=None,
                    help='specify the path of pointcloud file')
parser.add_argument('--result_file',
                    type=str,
                    default=None,
                    help='specify the path of vacc result file')
...
def vis_box3d(points_file, result_file):
    ...
    V.draw_scenes(points=points,
                  ...
                  ref_labels=pred_dicts[0]['pred_labels'].astype(np.int32))
