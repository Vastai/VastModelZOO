...
### modify.8 修改custom_dataset类实现
- 修改[custom_dataset.py](https://github.com/open-mmlab/OpenPCDet/blob/master/pcdet/datasets/custom/custom_dataset.py)
  - 建议直接使用此已修改文件：[custom_dataset.py](../source_code/onnx_utils/custom_dataset.py)，去替换原始同名文件
