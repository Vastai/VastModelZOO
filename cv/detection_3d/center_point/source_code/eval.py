...
parser.add_argument(
    "--result_npz",
    type=str,
    default="path/to/runmodel_output", 
...
def get_annos(dataset_yaml):
    ...
    result_str, result_dict = dataset.evaluation(det_annos, class_names, point_cloud_range=cfg.POINT_CLOUD_RANGE, eval_metric="kitti")

    print(result_str)


if __name__ == "__main__":
    get_annos(dataset_yaml=args.dataset_yaml)
