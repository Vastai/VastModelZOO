...
parse.add_argument("--model_prefix_path", type=str, default="deploy_weights/ultralytics_yolo11n_pose_fp16/mod", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="../build_in/vdsp_params/official-yolov11n-vdsp_params.json", 
    help="vdsp op info",
)
parse.add_argument(
...
if __name__ == '__main__':
    ...
    feature_decoder = Segmenter(model_size=[pose_detector.model_size_height, pose_detector.model_size_width], classes=args.label_txt, threashold=0.5)
    print(args.file_path)
    if os.path.isfile(args.file_path):
        result = pose_detector.run_sync(args.file_path)
