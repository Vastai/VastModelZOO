...
parse.add_argument("--body_vdsp_info",type=str,default="../vacc_code/vdsp_params/pytorch-body-vdsp_params.json",  help="body vdsp op info",)
parse.add_argument("--hand_prefix_path", type=str, default="./deploy_weights/hand/mod", help="model info")
parse.add_argument("--hand_vdsp_info",type=str,default="../vacc_code/vdsp_params/pytorch-hand-vdsp_params.json",  help="body vdsp op info",)
