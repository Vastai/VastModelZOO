...
parse.add_argument("--dataset_path", type=str, default="/path/to/eval/coco_val2017", help="path to input source image folder")
parse.add_argument("--target_path", type=str, default="/path/to/eval/coco_val2017_npz", help="path to output npz image folder")
