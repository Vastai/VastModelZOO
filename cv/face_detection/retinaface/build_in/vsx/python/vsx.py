...
parse.add_argument(
    "--file_path",
    type=str,
    default= "./datasets/widerface/val/images/",
    help="img or dir  path",
)
parse.add_argument("--model_prefix_path", type=str, default="deploy_weights/retinaface_resnet50-int8-kl_divergence-1_3_640_640-vacc-pipeline/mod", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="official-retinaface_resnet50-vdsp_params.json", 
    help="vdsp op info",
)
...
class FaceDetector:
    ...
    def post_processing(self, input_id, height, width, stream_output_list):
        ...
        # box_ids = stream_ouput_data[2]
        # classes = len(box_ids)
        box_scores = stream_ouput_data[0]
        # print('box_scores:\n', box_scores)

        # (classes, 4): xmin, ymin, xmax, ymax
        box_boxes = stream_ouput_data[1]
        box_boxes = np.reshape(box_boxes, (300, 4))
        # print('box_boxes:\n', box_boxes)
...
'''
==================== Results ====================
Easy   Val AP: 0.9405088404713557
Medium Val AP: 0.9026911860603879
Hard   Val AP: 0.6199839671953017
=================================================
'''