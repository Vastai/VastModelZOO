...
def set_config():
    ...
    parse.add_argument(
        "--lr_image_dir",
        type=str,
        default="/path/to/DIV2K/DIV2K_valid_LR_bicubic/X4",
    ...
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_real_esrgan_run_stream_int8/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-real_esrnet_x4plus-vdsp_params.json",
        help="vdsp op info",
    )
