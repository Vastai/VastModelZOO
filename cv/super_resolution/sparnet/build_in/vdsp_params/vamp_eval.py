...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="./code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/HR", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="./code/vamc/vamp/0.2.0/outputs/sparnet_light_attn3d", help="vamp output folder")
