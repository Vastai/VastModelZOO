...
def set_config():
    ...
    parse.add_argument(
        "--lr_image_dir",
        type=str,
        default="./code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/LR",
        help="lr_image_dir img dir",
    )
    parse.add_argument(
        "--hr_image_dir",
        type=str,
        default="./code/model_check/SR/face/Face-SPARNet/datasets/test_dirs/Helen_test_DIC/HR",
        help="hr_image_dir img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/sparnet_light_attn3d-int8-kl_divergence-3_128_128-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="super_resolution/sparnet/vacc_code/vdsp_params/official-sparnet_light_attn3d-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        # image = cv2.resize(image_lr, (128, 128))
...
mean psnr: 23.741642832436487, mean ssim: 0.594617252909323
sparnet_light_attn3d-int8-kl_divergence-3_128_128-vacc
mean psnr: 23.13178615319568, mean ssim: 0.5873667078528735
"""