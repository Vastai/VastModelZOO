...
def set_config():
    ...
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/bicubic_plusplus_2x-int8-kl_divergence-1_3_1080_1920-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-bicubic_plusplus_2x-vdsp_params.json",
        help="vdsp op info",
    )
