...
def set_config():
    ...
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_ncnet_run_stream_fp16/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-ncnet-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    # model  = torch.jit.load("deploy_weights/NCNET_model_best.torchscript.pt", map_location=device)
