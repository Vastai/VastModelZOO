...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="/path/to/code/model_check/SR/sr/NCNet/npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/ncnet", help="vamp output folder")
