...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/path/to/dataset/sr/CelebA/Img/img_align_celeba_1k", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/pfsrnet", help="vamp output folder")
