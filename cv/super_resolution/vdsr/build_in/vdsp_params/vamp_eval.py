...
if __name__ == "__main__":
    ...
    parse.add_argument("--src_dir", type=str, default="/path/to/code/model_check/SR/sr/pytorch-vdsr/Set5_BMP/scale_4", help="hr gt image folder")
    parse.add_argument("--gt_dir", type=str, default="/path/to/code/model_check/SR/sr/pytorch-vdsr/Set5_BMP/hr", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/drrn", help="vamp output folder")
