...
def set_config():
    ...
    parse.add_argument(
        "--lr_image_dir",
        type=str,
        default=" /path/to/realsr/DIV2K_valid_LR_128",
        help="lr_image_dir img dir",
    )
    parse.add_argument(
        "--hr_image_dir",
        type=str,
        default="/path/to/realsr/DIV2K_valid_HR_512",
        help="hr_image_dir img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_realsr_run_stream_fp16/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-DF2K-vdsp_params.json",
        help="vdsp op info",
    )
