...
def set_config():
    ...
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_rcan_run_stream_int8/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-rcan-vdsp_params.json",
        help="vdsp op info",
    )
...
2216_128_model_best-int8-max-1_3_1080_1920-vacc
mean psnr: 32.349224814431395, mean ssim: 0.7642811655565711

2216_128_model_best_dynamic.onnx
mean psnr: 32.91745891174335, mean ssim: 0.7757824703805656
