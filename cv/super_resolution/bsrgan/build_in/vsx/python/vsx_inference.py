...
def set_config():
    ...
    parse.add_argument(
        "--lr_image_dir",
        type=str,
        default="./code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_LR_bicubic/X2",
        help="lr_image_dir img dir",
    )
    parse.add_argument(
        "--hr_image_dir",
        type=str,
        default="./code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_HR",
        help="hr_image_dir img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/BSRGANx2-int8-percentile-3_128_128-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
...
mean psnr: 23.19276695602995, mean ssim: 0.6650782231893523

BSRGAN_x4-int8-percentile-3_128_128-vacc
mean psnr: 21.771233201230334, mean ssim: 0.592497206114451

BSRGAN_x2-int8-percentile-3_128_128-vacc
mean psnr: 23.14023098033097, mean ssim: 0.7095173808164676
"""