...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="/path/to/code/model_check/SR/deblur_denoise/Real-ESRGAN/datalist_npz.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="/path/to/code/vamc/vamp/0.2.0/outputs/bsrnet_x4", help="vamp output folder")
...
BSRNet_x4-int8-percentile-3_128_128-vacc
mean psnr: 23.19273235423876, mean ssim: 0.6429395765873787

BSRGAN_x4-int8-percentile-3_128_128-vacc
mean psnr: 21.771545346357907, mean ssim: 0.6008584798586426

BSRGANx2-int8-percentile-3_128_128-vacc
mean psnr: 23.129065296224503, mean ssim: 0.6847036701125123
