...
def set_config():
    ...
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/ecbsr_rgb_2x-int8-max-1_3_1080_1920-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="super_resolution/ecbsr/vacc_code/vdsp_params/basicsr-ecbsr_rgb_2x-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    #############################################################################
    # import onnxruntime
    # session = onnxruntime.InferenceSession("net_g_1476800_sim.onnx")
    # import torch
