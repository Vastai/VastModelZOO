...
if __name__ == "__main__":
    ...
    parse.add_argument("--lr_dir", type=str, default="./code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_LR_bicubic/X2", help="lr image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="./code/vamc/vamp/2.1.0/npz_output", help="vamp output folder")
