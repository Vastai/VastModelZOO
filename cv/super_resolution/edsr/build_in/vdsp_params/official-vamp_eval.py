...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_npz_path", type=str, default="./code/model_check/SR/BasicSR/datasets/DIV2K/DIV2K_valid_LR_bicubic/npz_datalist_X2.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="./code/vamc/vamp/0.2.0/outputs/edsr", help="vamp output folder")
