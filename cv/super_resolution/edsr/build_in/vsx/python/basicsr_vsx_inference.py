...
def set_config():
    ...
    parse.add_argument(
        "--hr_image_dir",
        type=str,
        default="/path/to/DIV2K_valid_HR",
        help="hr_image_dir img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/edsr_mx2-int8-percentile-3_768_1024-vacc/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/basicsr-edsr_mx2-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        # image = cv2.resize(image_lr, (1024, 768))
...
mean psnr: 33.346850934598436, mean ssim: 0.8539648822055946

GoPro
ckpt_gopro-int8-percentile-3_720_1280-vacc
mean psnr: 28.793632512107997, mean ssim: 0.8070983078087561
"""