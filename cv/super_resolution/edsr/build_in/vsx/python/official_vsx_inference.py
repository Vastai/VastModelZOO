...
def set_config():
    ...
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-edsr_baseline_x2-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        # image = cv2.resize(image_lr, (256, 256))
        ...
        # eval
        image_gt = cv2.imread(os.path.join(args.hr_image_dir, os.path.basename(image_path).replace(f"x{scale}", "")))
...
"""
# edsr_baseline_x2-3_256_256.onnx vacc runstream fp16精度
ean psnr: 22.706430795072027, mean ssim: 0.752835954778582

# edsr_baseline_x2-3_256_256.onnx vacc runstream int8精度
mean psnr: 22.748112599145816, mean ssim: 0.7489527978498279

# edsr_baseline_x4-3_256_256.onnx vacc runmodel fp16精度
mean psnr: 25.870283122713996, mean ssim: 0.7724276500631235

# edsr_baseline_x4-3_256_256.onnx vacc runstream int8精度
mean psnr: 25.692760704761223, mean ssim: 0.763956923349189
"""