...
def set_config():
    ...
    parse.add_argument(
        "--lr_image_dir",
        type=str,
        default="/path/to/CelebAMask-HQ/GPEN/lq",
        help="lr_image_dir img dir",
    )
    parse.add_argument(
        "--hr_image_dir",
        type=str,
        default="/path/to/CelebAMask-HQ/GPEN/hq",
        help="hr_image_dir img dir",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="deploy_weights/official_gpen_run_stream_int8/mod",
        help="model info")
    parse.add_argument(
        "--vdsp_params_info",
        type=str,
        default="../vacc_code/vdsp_params/official-gpen-vdsp_params.json",
        help="vdsp op info",
    )
...
if __name__ == '__main__':
    ...
    # model  = torch.jit.load("gpen-512.torchscript.pt", map_location=device)
    ...
    for (image_path, result) in tzip(image_files, results):
        ...
        # image = cv2.resize(image_lr, (512, 512))
...
"""
gpen-512.torchscript.pt
mean psnr: 26.1091735867142, mean ssim: 0.6917913844536552

gpen-fp16-none-1_3_512_512-vacc
mean psnr: 26.114663123675346, mean ssim: 0.6918858741380794

gpen-int8-mse-3_512_512-vacc
mean psnr: 25.85621667297042, mean ssim: 0.6672703512877035
