...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="./code/eval/GPEN/hq", help="hr gt image folder")
    parse.add_argument("--input_npz_path", type=str, default="datalist_npz.txt", help="npz text file")
    parse.add_argument("--out_npz_dir", type=str, default="./code/vamc/vamp/0.2.0/save/gpen", help="vamp output folder")
