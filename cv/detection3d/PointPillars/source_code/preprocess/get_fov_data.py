...
parser.add_argument("--dataset_yaml", type=str, default = "/path/to/OpenPCDet/tools/cfgs/dataset_configs/kitti_dataset.yaml", help = "dataset yaml file")
parser.add_argument("--data_path", type=str, default = "/path/to/OpenPCDet/data/kitti", help="data path")
