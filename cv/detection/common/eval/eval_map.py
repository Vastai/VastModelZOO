...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt", type=str, default="/path/to/instances_val2017.json", help="gt json")
    parse.add_argument("--txt", type=str, default="/path/to/output", help="txt files")
