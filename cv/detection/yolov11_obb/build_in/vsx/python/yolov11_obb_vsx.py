...
def process_yolo11_obb_output(outputs_model, input_size=640):
    """
    处理YOLO11-OBB模型的输出
    """
    outputs_new = []
...
parse = argparse.ArgumentParser(description="RUN YOLO11-OBB WITH VSX")
parse.add_argument(
    "--file_path",
    type=str,
...
parse.add_argument("--model_prefix_path", type=str, default="/source/vamc/yolo11-obb/deploy_weights/ultralytics_yolo11n_obb_fp16_nopost/mod", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="/source/modelzoo/detection/yolov11/vacc_code/vdsp_params/official-yolov11n-vdsp_params.json", 
    help="vdsp op info",
)
        ...
        while True:
            try:
                ...
                if result is not None:
                    ...
                    # 使用YOLO11-OBB后处理
                    detected_boxes = process_yolo11_obb_output(outputs_model, self.model_size)
