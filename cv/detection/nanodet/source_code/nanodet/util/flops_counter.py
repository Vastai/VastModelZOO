...
def deconv_flops_counter_hook(conv_module, input, output):
    ...
    filters_quantize_per_channel = out_channels // groups
    conv_per_position_flops = (
        kernel_height * kernel_width * in_channels * filters_quantize_per_channel
    )
...
def conv_flops_counter_hook(conv_module, input, output):
    ...
    filters_quantize_per_channel = out_channels // groups
    conv_per_position_flops = (
        int(np.prod(kernel_dims)) * in_channels * filters_quantize_per_channel
    )
