...
### step.4 模型推理
    ...
    python ../build_in/vsx/python/nanodet_vsx.py \
        ...
        --model_prefix_path deploy_weights/official_nanodet_int8/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/official_nanodet_int8/mod --vdsp_params ../build_in/vdsp_params/official-nanodet_plus_m-vdsp_params.json -i 2 p 2 -b 1
    ```
...
2. 精度测试
    ...
    - vmpp推理，获取npz结果输出
    ```bash
    vamp -m deploy_weights/official_nanodet_int8/mod --vdsp_params ../build_in/vdsp_params/official-nanodet_plus_m-vdsp_params.json -i 2 p 2 -b 1 --datalist npz_datalist.txt --path_output npz_output
    ```
