...
parser.add_argument("--path_res", type=str, default="./code/modelzoo/algorithm_modelzoo/outputs_images/detect_results.json", help="model detection results path *.json")
parser.add_argument("--path_ann_file", type=str, default="./code/model_check/vit_custom_models/yolo-world/lvis_v1_minival_inserted_image_name.json", help="detection dataset ground truth results path *.json")

args = parser.parse_args()
path_res = args.path_res
path_ann_file = args.path_ann_file
...
def get_data_evaluate(path_ann_file, path_res):
    ...
    if False:  # Compute per-category AP
...
eva = get_data_evaluate(path_ann_file, path_res)


'''
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=300 catIds=all] = 0.346
 Average Precision  (AP) @[ IoU=0.50      | area=   all | maxDets=300 catIds=all] = 0.455
 Average Precision  (AP) @[ IoU=0.75      | area=   all | maxDets=300 catIds=all] = 0.378
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=     s | maxDets=300 catIds=all] = 0.254
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=     m | maxDets=300 catIds=all] = 0.455
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=     l | maxDets=300 catIds=all] = 0.539
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=300 catIds=  r] = 0.292
 Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=300 catIds=  c] = 0.328
 ...
 Average Recall     (AR) @[ IoU=0.50:0.95 | area=     s | maxDets=300 catIds=all] = 0.292
 Average Recall     (AR) @[ IoU=0.50:0.95 | area=     m | maxDets=300 catIds=all] = 0.567
 Average Recall     (AR) @[ IoU=0.50:0.95 | area=     l | maxDets=300 catIds=all] = 0.672
