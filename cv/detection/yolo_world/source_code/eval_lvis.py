...
parser.add_argument("--path_res", type=str, default="./detect_results.json", help="model detection results path *.json")
parser.add_argument("--path_ann_file", type=str, default="./yolo-world/lvis_v1_minival_inserted_image_name.json", help="detection dataset ground truth results path *.json")
