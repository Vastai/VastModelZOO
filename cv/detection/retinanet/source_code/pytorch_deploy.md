...
### step.4 模型推理
    ...
    python ../build_in/vsx/python/pytorch_retinanet_vsx.py \
        ...
        --model_prefix_path deploy_weights/pytorch_retinanet_fp16/mod \
...
1. 性能测试
    ```bash
    vamp -m deploy_weights/pytorch_retinanet_fp16/mod --vdsp_params ../build_in/vdsp_params/pytorch-retinanet_resnet50-vdsp_params.json -i 1 -b 1 -d 0 -p 1
    ```
