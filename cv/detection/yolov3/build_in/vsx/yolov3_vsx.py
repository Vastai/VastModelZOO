...
parse.add_argument(
    "--file_path",
    type=str,
    default= "/path/to/coco/det_coco_val/",
    help="img or dir  path",
)
parse.add_argument("--model_prefix_path", type=str, default="/path/to/yolov3/mod", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
    default="/path/to/yolov3-vdsp_params.json", 
    help="vdsp op info",
)
parse.add_argument(
