...
- 推理参考：[yolov3_vsx.py](../build_in/vsx/yolov3_vsx.py)
    ...
    python ../build_in/vsx/yolov3_vsx.py \
        ...
        --model_prefix_path deploy_weights/ultralytics_yolov3_int8/mod \
...
1. 性能测试
    ```bash
    vamp -m deploy_weights/ultralytics_yolov3_int8/mod  --vdsp_params ../vacc_code/vdsp_params/ultralytics-yolov3-vdsp_params.json -i 2 p 2 -b 1
    ```
...
2. 精度测试
    ...
    - vamp推理获取npz结果输出
    ```bash
    vamp -m deploy_weights/ultralytics_yolov3_int8/mod \
