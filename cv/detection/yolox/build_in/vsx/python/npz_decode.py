...
if __name__=='__main__':
    ...
    parse.add_argument(
        "--input_image_dir",
        type=str,
        default="./Documents/project/det_data/coco/val2017",
    ...
    parse.add_argument(
        "--vamp_output_dir",
        type=str,
        default="./Desktop/model_latency_npz",
    ...
    parse.add_argument("--save_dir", type=str, default="./Desktop/output", help="save_dir")
