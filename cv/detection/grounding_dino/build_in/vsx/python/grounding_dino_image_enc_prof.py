...
from groundingdino import GroundingDinoImage
from groundingdino_prof import ModelProfiler
...
def argument_parser():
    ...
    parser.add_argument(
        "-m",
        "--model_prefix",
        default="/path/to/img_encoder/mod",
    ...
    parser.add_argument(
        "--vdsp_params",
        default="/path/to/groundingdino_bgr888.json",
