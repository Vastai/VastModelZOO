...
class GroundingDINO(nn.Module):
    ...
    #     # xjg
    #     # deformable-detr-like anchor update
    #     layer_ref_sig, layer_bbox_embed, layer_hs = reference[-2], self.bbox_embed[-1], hs[-1]

    #     layer_delta_unsig = layer_bbox_embed(layer_hs)
    #     layer_outputs_unsig = layer_delta_unsig + inverse_sigmoid(layer_ref_sig)
    #     layer_outputs_unsig = layer_outputs_unsig.sigmoid()

    #     layer_cls_embed = self.class_embed[-1]
    #     outputs_class = layer_cls_embed(layer_hs, text_dict)
    #     out = {"pred_logits": outputs_class, "pred_boxes": layer_outputs_unsig}
