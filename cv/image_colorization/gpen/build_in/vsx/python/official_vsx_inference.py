...
def set_config():
    ...
    parse.add_argument("--lr_image_dir",type=str,default="/path/to/GPEN/hq_gray",help="lr_image_dir img dir",)
    parse.add_argument("--hr_image_dir",type=str,default="/path/to/GPEN/hq",help="hr_image_dir img dir",)
    parse.add_argument("--model_prefix_path",type=str,default="deploy_weights/official_gpen_run_stream_fp16/mod",help="model info")
    parse.add_argument("--vdsp_params_info",type=str,default="../vacc_code/vdsp_params/official-gpen-vdsp_params.json",help="vdsp op info")
...
if __name__ == '__main__':
    ...
    # model  = torch.jit.load("1125000_gema-512.torchscript.pt", map_location=device)
