...
parse.add_argument("--dataset_path", type=str, default="/path/to/dataset/face/lfw_mtcnnpy_160")
parse.add_argument("--target_path", type=str, default="/path/to/dataset/face/lfw_mtcnnpy_160_npz")
