...
### step.4 模型推理
    ...
    python ../build_in/vsx/python/vsx_infer.py \
        ...
        --model_prefix_path deploy_weights/official_pipnet_fp16/mod \
...
1. 性能测试
    ...
    ```bash
    vamp -m deploy_weights/official_pipnet_int8/mod --vdsp_params ../build_in/vdsp_params/official-pip_resnet18-vdsp_params.json -i 2 p 2 -b 2
    ```
...
2. 精度测试
    ...
    - vamp推理获取npz结果
    ```bash
    vamp -m deploy_weights/official_pipnet_int8/mod \
