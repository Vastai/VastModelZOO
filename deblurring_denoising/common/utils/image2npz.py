...
if __name__ == "__main__":
    ...
    parse.add_argument("--dataset_path", type=str, default="/home/simplew/code/model_check/SR/deblur_denoise/MIMO-UNet/GoPro/test/input", help="path to input source image folder")
    parse.add_argument("--target_path", type=str, default="/home/simplew/code/model_check/SR/deblur_denoise/MIMO-UNet/GoPro/test/input_npz", help="path to output npz image folder")
