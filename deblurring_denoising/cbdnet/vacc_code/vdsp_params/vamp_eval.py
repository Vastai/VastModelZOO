...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="/home/simplew/dataset/denoise/SIDD/val/target", help="path to input source image folder")
...
mean psnr: 37.56200025717918, mean ssim: 0.8894526020300104
