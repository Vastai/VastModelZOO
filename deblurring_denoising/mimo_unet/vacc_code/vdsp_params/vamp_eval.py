...
if __name__ == "__main__":
    ...
    parse.add_argument("--gt_dir", type=str, default="GoPro/test/target", help="path to input source image folder")
    parse.add_argument("--input_npz_path", type=str, default="npz_datalist.txt", help="vamp data list text file path")
    ...
    parse.add_argument("--input_shape", nargs='+', type=int, default=[360, 640], help="vamp input shape")
...
"""
MIMO-UNet-fp16-none-1_3_360_640-vacc
mean psnr: 29.55296793316135, mean ssim: 0.8997806051733304

MIMO-UNet-int8-percentile-1_3_360_640-vacc
mean psnr: 29.27605662808231, mean ssim: 0.8854923742182957
