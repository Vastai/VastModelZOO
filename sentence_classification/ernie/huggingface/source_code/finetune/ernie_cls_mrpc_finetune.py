...
from transformers import ErnieForSequenceClassification, AutoTokenizer, DataCollatorWithPadding, TrainingArguments, Trainer
...
if __name__ == '__main__':
    ...
    parse.add_argument(
        "--model_name_or_path", 
        type=str,
        default="/home/jies/code/nlp/transformers/weights/ernie2.0-base-en",
    ...
    parse.add_argument(
        "--output_dir",
        type=str,
        default="/home/jies/code/nlp/transformers/runs/MRPC_for_seqclassification_ernie2_base_en",
    ...
    model = ErnieForSequenceClassification.from_pretrained(model_name_or_path, num_labels=num_labels)
