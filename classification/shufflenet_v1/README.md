...
2. 性能测试
    ```bash
    ./vamp -m shufflenet_v1-int8-percentile-3_256_256-vacc/shufflenet_v1 --vdsp_params ./vacc_code/vdsp_params/timm-shufflenet_v1-vdsp_params.json  -i 8 -p 1 -b 22
    ```
    
3. 获取精度信息
    ```bash
    ./vamp -m shufflenet_v1-int8-percentile-3_256_256-vacc/shufflenet_v1 --vdsp_params ./vacc_code/vdsp_params/timm-shufflenet_v1-vdsp_params.json  -i 8 -p 1 -b 22 --datalist npz_datalist.txt --path_output output
    ```
4. 结果解析及精度评估
    ```bash
