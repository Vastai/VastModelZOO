...
2. 性能测试
    ```bash
    ./vamp -m pplcnet_x0_25-int8-percentile-3_224_224-vacc/pplcnet_x0_25 --vdsp_params ./vacc_code/vdsp_params/ppcls-pplcnet_x0_25-vdsp_params.json  -i 8 -p 1 -b 22
    ```
    
3. 获取精度信息
    ```bash
    ./vamp -m pplcnet_x0_25-int8-percentile-3_224_224-vacc/pplcnet_x0_25 --vdsp_params ./vacc_code/vdsp_params/ppcls-pplcnet_x0_25-vdsp_params.json  -i 8 -p 1 -b 22 --datalist npz_datalist.txt --path_output output
    ```
4. 结果解析及精度评估
    ```bash
