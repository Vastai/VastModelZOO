...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.file_path):
        inputs = [np.ones((256,), dtype=np.int32), 
                np.ones((256,), dtype=np.int32),
                np.ones((256,), dtype=np.int32)]#np.load(args.file_path)
        ...
        inputs_list = [[np.ones((256,), dtype=np.int32), 
                        np.ones((256,), dtype=np.int32),
                        np.ones((256,), dtype=np.int32)] for i in range(16)]
