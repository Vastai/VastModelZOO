...
parse.add_argument(
    "--model_info", type=str, default='./network.json', help="Required configuration file to run python runstream.")
parse.add_argument(
    "--bytes_size", type=int, default=1024, help="sequence byte length")
parse.add_argument(
...
parse.add_argument(
    "--save_dir", type=str, default='../result/ner', help="save runstream results path")
