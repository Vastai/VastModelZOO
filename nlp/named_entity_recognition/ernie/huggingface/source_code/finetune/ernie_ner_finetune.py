...
from transformers import ErnieForTokenClassification, AutoTokenizer, TrainingArguments, Trainer 
...
def get_args():
    ...
    parse.add_argument(
        "--model_name_or_path", 
        type=str,
        default="./code/nlp/transformers/weights/ernie2.0-base-en",
    ...
    parse.add_argument(
        "--output_dir",
        type=str,
        default="./code/nlp/transformers/runs/Pople_for_ner_ernie2_base_en",
...
if __name__ =='__main__':
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, do_lower_case=True) # create tokenizer
    ...
    model = ErnieForTokenClassification.from_pretrained(model_name_or_path, num_labels=num_labels)
