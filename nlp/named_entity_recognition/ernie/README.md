...
### step.1 模型 finetune
-  huggingface，模型微调说明：[huggingface_ernie_peple_daily.md](./huggingface/source_code/finetune/huggingface_ernie_peple_daily.md)
...
### step.3 获取数据集
- 校准数据集
    - [huggingface-ernie2](https://drive.google.com/drive/folders/1OrYI9MXg7w4GEew-3GQ0mGD5VttMmanU)
    - [huggingface-ernie3](https://drive.google.com/drive/folders/1kdcQLNOX5aWOCSPZfz8UjTcZwUjlhUvF)
- [评估数据集-v1.3-ernie2](https://drive.google.com/drive/folders/1E0Z1lDB7LXnv351pNJfC_puFAWIQak8L)
- [评估数据集-v1.3-ernie3](https://drive.google.com/drive/folders/1udC5rH-_IjUJOg1TUoNX_COeK7yZOZUN)
- [评估数据集-v1.5-ernie2](https://drive.google.com/drive/folders/10FRvD9Qtki96DXQnMZs4hIVrevQ_Lz8-)
- [评估数据集-v1.5-ernie3](https://drive.google.com/drive/folders/1lpWFGChOkD4cwLHWnyRxmfqHmiHraSl-)
- labels: [instance_Peoples_Daily.txt](https://drive.google.com/drive/folders/15O2QrYHCXVP8NjwwByFQ6lUPbYOHvf-r)
> 由于 ernie2 与 ernie3 的 vocab 分词不同，因此校验数据集与评估数据集按照其对应的模型分别进行处理，并且由于 compiler 1.5 版本输入个数的改变，不同版本也有不同的评估数据集

### step.4 模型转换
1. 根据具体模型修改配置文件

   - [huggingface_ernie2.0_base_en_ner-256](./huggingface/build_in/build/huggingface_ernie2.0_base_en_ner-256.yaml)
   - [huggingface_ernie3.0_base_zh_ner-256](./huggingface/build_in/build/huggingface_ernie3.0_base_zh_ner-256.yaml)
...
2. 模型编译
    ...
    mkdir workspace
    cd workspace
    vamc compile ../huggingface/build_in/build/huggingface_ernie2.0_base_en_ner-256.yaml
    vamc compile ../huggingface/build_in/build/huggingface_ernie3.0_base_zh_ner-256.yaml
    vamc compile ../huggingface/build_in/build/huggingface_ernie3.0_medium_zh_ner-256.yaml
    vamc compile ../huggingface/build_in/build/huggingface_ernie3.0_xbase_zh_ner-256.yaml
    ```
...
- 基于 [sequence2npz.py](../../sentence_classification/common/utils/sequence2npz.py)，获得推理数据`npz`以及对应的`npz_datalist.txt`
   ...
   python ../../common/utils/sequence2npz.py \
    ...
    # ernie2.0
    python ../../common/utils/sequence2npz.py \
       --npz_path /path/to/ernie2/test4636_int32_6inputs \
       --save_path npz_datalist.txt

    # ernie3.0
    python ../../common/utils/sequence2npz.py \
       --npz_path /path/to/ernie3/test4636_int32_6inputs \
       --save_path npz_datalist.txt
   ```
...
- 推理 运行
  ...
  - `compiler version >= 1.5.2 并且 vastsream sdk == 2.X`
    ...
    python ../../common/vsx/python/vsx_ner.py \
        ...
        --model_prefix_path ./deploy_weights/ernie2.0_base_en_ner-256/mod  \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie2.0_base_en_out
    # vacc fp16
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/fp16/ernie2.0_base_en_ner-256/mod  \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie2.0_base_en_out_fp16

    ## torchscript fp32 
    python ../../common/utils/run_torchscript.py \
        --data_list npz_datalist.txt \
        --model_path ../huggingface/source_code/pretrain_model/ernie2.0_base_en_ner-256.torchscript.pt \
        --save_dir ./ernie2.0_base_en_torch_out

    # ernie3.0_base_zh_ner-256
    ## vacc int8 
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/ernie3.0_base_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_base_zh_out
    ## vacc fp16
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/fp16/ernie3.0_base_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_base_zh_out_fp16

    ## torchscript fp32 
    python ../../common/utils/run_torchscript.py \
        --data_list npz_datalist.txt \
        --model_path ../huggingface/source_code/pretrain_model/ernie3.0_base_zh_ner-256.torchscript.pt \
        --save_dir ./ernie3.0_base_zh_torch_out

    # ernie3.0_medium_zh_ner-256
    ## vacc int8 
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/ernie3.0_medium_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_medium_zh_out
    ## vacc fp16
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/fp16/ernie3.0_medium_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_medium_zh_out_fp16

    ## torchscript fp32 
    python ../../common/utils/run_torchscript.py \
        --data_list npz_datalist.txt \
        --model_path ../huggingface/source_code/pretrain_model/ernie3.0_medium_zh_ner-256.torchscript.pt \
        --save_dir ./ernie3.0_medium_zh_torch_out
    
    # ernie3.0_xbase_zh_ner-256
    ## vacc int8 
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/ernie3.0_xbase_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_xbase_zh_out
    ## vacc fp16
    python ../../common/vsx/python/vsx_ner.py \
        --data_list npz_datalist.txt \
        --model_prefix_path ./deploy_weights/fp16/ernie3.0_xbase_zh_ner-256/mod \
        --device_id 0 \
        --batch 1 \
        --save_dir ./ernie3.0_xbase_zh_out_fp16

    ## torchscript fp32 
    python ../../common/utils/run_torchscript.py \
        --data_list npz_datalist.txt \
        --model_path ../huggingface/source_code/pretrain_model/ernie3.0_xbase_zh_ner-256.torchscript.pt \
        --save_dir ./ernie3.0_xbase_zh_torch_out
    ```
...
- 精度评估
   ...
   ```bash
    # ernie2.0_base_en_ner-256
    ## vacc int8 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie2.0_base_en_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## vacc fp16
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie2.0_base_en_out_fp16 \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## torchscript fp32 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie2.0_base_en_torch_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    # ernie3.0_base_zh_ner-256
    ## vacc int8 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_base_zh_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## vacc fp16
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_base_zh_out_fp16 \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## torchscript fp32 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_base_zh_torch_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    # ernie3.0_medium_zh_ner-256
    ## vacc int8 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_medium_zh_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## vacc fp16
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_medium_zh_out_fp16 \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## torchscript fp32 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_medium_zh_torch_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    # ernie3.0_xbase_zh_ner-256
    ## vacc int8 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_xbase_zh_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## vacc fp16
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_xbase_zh_out_fp16 \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt

    ## torchscript fp32 
    python ../../common/eval/people_daily_eval.py \
    --result_dir ./ernie3.0_xbase_zh_torch_out \
    --label_path /path/to/people_daily/instance_Peoples_Daily.txt
   ...
   ```bash
    # ernie2.0_base_en_ner-256 
    ## vacc int8 
    F1:  0.2729844413012729
    accuracy:  0.8362417025935811

    ## vacc fp16
    F1:  0.5333741579914268
    accuracy:  0.8581400123177992

    ## torchscript fp32 
    F1:  0.5327617881200244
    accuracy:  0.8582084445356875
    ----------------------------
    # ernie3.0_base_zh_ner-256
    ## vacc int8 
    F1:  0.7538776704711735
    accuracy:  0.9289673578320673
    
    ## vacc fp16
    F1:  0.8322109988776656
    accuracy:  0.941627318141381

    ## torchscript fp32 
    F1:  0.8324445691832726
    accuracy:  0.941627318141381
    ----------------------------
    # ernie3.0_medium_zh_ner-256
    ## vacc int8 
    F1:  0.7927068723702665
    accuracy:  0.93526312187778

    ## vacc fp16
    F1:  0.8308988764044942
    accuracy:  0.9442277424211318
    ...
    ----------------------------
    # ernie3.0_xbase_zh_ner-256
    F1:  0.840440553515956
    accuracy:  0.9471703277903237

    ## vacc fp16
    F1:  0.8471517202481669
    accuracy:  0.9483336754944228

    ## torchscript fp32 
    F1:  0.8474767409078093
    accuracy:  0.9484021077123109
    ----------------------------
    ```
...
2. 执行测试：
    ...
    vamp -m deploy_weights/ernie2.0_base_en_ner-256/mod \
        ...
        --processes 1 \
        --datalist npz_datalist.txt \
        --path_output ./vamp_ernie2.0_base_en_out
    
    vamp -m deploy_weights/ernie3.0_base_zh_ner-256/mod \
        --shape [[1,256],[1,256],[1,256],[1,256],[1,256],[1,256]] \
        --vdsp_params ../../common/vamp_info/bert_vdsp.json \
        --batch_size 1 \
        --instance 1 \
        --processes 1 \
        --datalist npz_datalist.txt \
        --path_output ./vamp_ernie3.0_base_zh_out
    
    vamp -m deploy_weights/ernie3.0_medium_zh_ner-256/mod \
        --shape [[1,256],[1,256],[1,256],[1,256],[1,256],[1,256]] \
        --vdsp_params ../../common/vamp_info/bert_vdsp.json \
        --batch_size 1 \
        --instance 1 \
        --processes 1 \
        --datalist npz_datalist.txt \
        --path_output ./vamp_ernie3.0_medium_zh_out
    
    vamp -m deploy_weights/ernie3.0_xbase_zh_ner-256/mod \
        --shape [[1,256],[1,256],[1,256],[1,256],[1,256],[1,256]] \
        --vdsp_params ../../common/vamp_info/bert_vdsp.json \
        --batch_size 1 \
        --instance 1 \
        --processes 1 \
        --datalist npz_datalist.txt \
        --path_output ./vamp_ernie3.0_xbase_zh_out
    ```
