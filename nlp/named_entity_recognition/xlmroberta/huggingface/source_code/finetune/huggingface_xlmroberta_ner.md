...
运行 xlmroberta_ner_finetune.py
```bash
cd VastModelZOO/nlp/named_entity_recognition/xlmroberta/huggingface/source_code/finetune

python xlmroberta_ner_finetune.py \
    --model_name_or_path path/to/pretrain_model/xlmroberta_base_ner \
