...
parse.add_argument("--model_prefix_path", type=str, default="./work/VSX/minio_models/fp16/bert_large_en_qa_384-fp16-none-mutil_input-vacc/bert_large_en_qa_384", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.file_path):
        inputs = [np.ones((384,), dtype=np.int32), 
                np.ones((384,), dtype=np.int32),
                np.ones((384,), dtype=np.int32)]#np.load(args.file_path)
        ...
        # for npz in npz_file:
        #     inputs = np.load(npz)
        #     inputs_list.append([inputs['input_ids'],inputs['token_type_ids'],inputs['attention_mask']])
        inputs_list = [[np.ones((384,), dtype=np.int32), 
                        np.ones((384,), dtype=np.int32),
                        np.ones((384,), dtype=np.int32)] for i in range(16)]
