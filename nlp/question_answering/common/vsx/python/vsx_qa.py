...
if __name__ == '__main__':
    ...
    parse.add_argument(
        "--data_list",
        type=str,
        default="./code/vmc/datasets/nlp/squad_v1_1/npz_datalist.txt",
        help="img or dir path",
    )
    parse.add_argument(
        "--model_prefix_path",
        type=str,
        default="./code/vmc/deploy_weights/bert_qa/hg_bert_base_en_qa-384-int8-max-1_384_1_384_1_384-vacc/mod",
        help="model info"
    )
    parse.add_argument("--device_id", type=int, default=0, help="device id")
    parse.add_argument("--batch", type=int, default=8, help="bacth size")
