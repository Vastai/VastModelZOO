...
> [paper](https://arxiv.org/abs/2308.03281)
...
| :----------------------------------------------------------: | :-------: | :-------------: | :----------------------------------------------------------: |
|      [thenlper/gte-large](https://huggingface.co/thenlper/gte-large)       |   1024    |      512       | multilingual |
|      [thenlper/gte-base](https://huggingface.co/thenlper/gte-base)       |   1024    |      512       | multilingual |
|      [thenlper/gte-small](https://huggingface.co/thenlper/gte-small)       |   384    |      512       | multilingual |
...
- gte官网提供的average_pool+normalize
  
  针对gte-base/smalle/large，提供了关于average_pool+Normalization(Optionally)的后处理, 根据每一条sentence的embedding，和对应sentence中token的数量进行pool。
