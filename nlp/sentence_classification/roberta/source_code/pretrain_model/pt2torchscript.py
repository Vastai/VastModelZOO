...
if __name__ == '__main__':
    ...
    parse.add_argument(
        "--save_path",
        type=str,
        default="./code/nlp/transformers/runs/bert_test/checkpoint-2300/cls_bert_base.torchscript.pt",
    ...
    model = BertForSequenceClassification.from_pretrained(model_name_or_path, return_dict=False)
