...
def get_args(**kwargs):
    ...
    parse.add_argument("--init_checkpoint", type=str,  default='./code/nlp/bert/tmp/bert_large_b64_epoch20/model.ckpt-1146')
    parse.add_argument("--bert_config_file", type=str, default='./code/nlp/bert/weights/wwm_uncased_L-24_H-1024_A-16/bert_config.json')
    parse.add_argument("--max_seq_length", type=int, default=128)
    parse.add_argument("--output_dir", type=str, default='./code/nlp/bert/tmp/bert_large_b64_epoch20')
