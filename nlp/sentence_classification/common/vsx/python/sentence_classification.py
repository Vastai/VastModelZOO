...
parse.add_argument("--model_prefix_path", type=str, default="./work/VSX/minio_models/fp16/bert_base_zh_mcls_128-fp16-none-mutil_input-vacc/bert_base_zh_mcls_128", help="model info")
parse.add_argument(
    "--vdsp_params_info",
    type=str,
