...
if __name__ == '__main__':
    ...
    parser.add_argument("--labels_path", type=str, default='./electra/label.txt', help='sst2 validation-set label file')
    parser.add_argument("--result_dir", type=str, default='./runstream/result/electra_512/', help='runstream result save path')
