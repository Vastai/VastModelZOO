...
parse.add_argument(
    "--model_info", type=str, default='./bert_cls/network.json', help="Required configuration file to run python runstream.")
parse.add_argument(
    "--bytes_size", type=int, default=512, help="sequence byte length")
parse.add_argument(
    "--datalist_path", type=str, default='./npz_datalist.txt', help="input *.npz datalist path")
parse.add_argument(
    "--device_id", type=int, default=0, help="device id")
parse.add_argument(
    "--batch_size", type=int, default=1, help="run batch num.")
parse.add_argument(
    "--save_dir", type=str, default='../result/cls', help="save runstream results path")
