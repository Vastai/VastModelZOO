...
parser.add_argument(
    "--method_jsons", required=False, type=list, default=["examples/config_method.json"], help="The json file about all methods."
)
parser.add_argument(
    "--dataset_jsons", required=False, type=list, default=["examples/config_dataset.json"], help="The json file about all datasets."
)
